...
const examplesData: ExampleProject[] = [
  ...
  },
  {
    ...
    slug: '/examples/salon',
    category: 'salon',
    titleEn: 'Aura Botanical Sanctuary',
    titleSq: 'Aura Botanical Sanctuary',
    industryEn: 'Aesthetic Skincare & Thermal Spa',
    industrySq: 'Sallon, Spa & Kujdes Personal',
    descEn: 'Organic modernism aesthetic featuring a 4-step appointment booking wizard, interactive treatment price cards, and expandable FAQ section.',
    descSq: 'Estetikë organike me caktim takimi 4-hapësh, çmime të qarta shërbimesh dhe seksion pyetjesh të shpeshta.',
    urlPreview: 'aurastudio.al',
    featuresEn: ['4-Step Appointment Wizard', 'Interactive Ritual Price List', 'Specialist & Time Selector', '100% Organic Products'],
    featuresSq: ['Magjistar Takimesh 4-Hapësh', 'Listë Çmimesh Interaktive', 'Përzgjedhje Specialisti & Orareve', '100% Produkte Organike'],
    palette: ['#f7f5f0', '#ebe5da', '#556b5a', '#261f1c'],
    accentColor: '#556b5a',
    darkPreview: false,
    previewHeroTitle: {
      en: 'Refined aesthetics meet restorative calm.',
      sq: 'Estetika e rafinuar takon qetësinë e thellë.',
    },
    previewHeroImage: 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80',
    previewSubtext: {
      en: 'Organic botanical scalp therapies and volcanic hot basalt stone rituals.',
      sq: 'Trajtime botanike organike dhe masazh me gurë të ngrohtë vullkanikë.',
    },
  },
  {
    id: 'professional',
      ...
      >
        ...
        >
          {[
            ...
            { id: 'salon', en: 'Salon & Spa', sq: 'Sallon & Spa' },
